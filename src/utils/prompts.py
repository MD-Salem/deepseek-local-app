...
def cancel_generation(cancel_flag):
    cancel_flag[0] = True  # Modify the list in-place
    return cancel_flag
...
# Update the Chatbot component to include the type parameter
chatbot = gr.Chatbot(
    ...
    height="70vh",
    show_label=False,
    type="messages"  # Add this line to fix the deprecation warning
)
